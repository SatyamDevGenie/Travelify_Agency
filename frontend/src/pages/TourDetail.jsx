...
const TourDetail = () => {
    ...
    if (singleLoading)
        return <p className="text-center mt-10 text-xl sm:text-2xl font-semibold text-indigo-600">Loading Tour...</p>;
    if (singleError)
        return <p className="text-center text-red-500 mt-10 text-xl sm:text-2xl font-semibold">{singleError}</p>;
            ...
            <div className="bg-white shadow-2xl rounded-3xl overflow-hidden transform transition duration-500 hover:scale-[1.01] border border-gray-100">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2">
                    ...
                    <div className="p-6 sm:p-8 md:p-12 lg:p-16 space-y-6 sm:space-y-8">
                        <div>
                            <span className="inline-flex items-center rounded-full bg-indigo-100 px-3 py-1 text-xs sm:text-sm font-medium text-indigo-700 ring-1 ring-inset ring-indigo-200 uppercase tracking-wider mb-2 sm:mb-3">
                                🌟 Exclusive Tour
                            </span>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 pt-4 border-t border-gray-100">
                            <div className="flex items-center space-x-3 p-3 sm:p-4 bg-gray-50 rounded-xl shadow-inner">
                                <span className="text-2xl sm:text-3xl text-indigo-500">📍</span>
                                <div>
                                    <p className="text-sm sm:text-base font-medium text-gray-500">Location</p>
                                    <p className="text-lg sm:text-xl font-semibold text-gray-800">{singleTour.location}</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center space-x-3 p-3 sm:p-4 bg-gray-50 rounded-xl shadow-inner">
                                ...
                                <div>
                                    <p className="text-sm sm:text-base font-medium text-gray-500">Available Slots</p>
                                    <p className="text-lg sm:text-xl font-semibold text-gray-800">{singleTour.availableSlots}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="pt-6 sm:pt-8 space-y-4 sm:space-y-6">
                            <p className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-indigo-700">
                                Price: <span className="ml-1 sm:ml-2">₹{singleTour.price.toLocaleString("en-IN")}</span>
                                <span className="text-sm sm:text-base md:text-lg font-normal text-gray-500"> / per person</span>
                            </p>
